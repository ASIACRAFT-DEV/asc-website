...
const FEATURES = {
  ...
  dungeons: {
    ...
    how: [
      ...
      },
      {
        ...
        body:
          'Boss Rush dungeons can be <strong>PvP zones</strong>, and <strong>both open dungeons are</strong> — the Solforge Nexus and Magma Palace alike. Another party can walk in and sabotage your run — that is the point of it. Both fighters have to be inside the same dungeon, so an arrow from outside still bounces. A PvP kill <strong>spends a dungeon life</strong> like any other death and your corpse stays owner-locked, so nobody loots the player they just killed: what you lose is the life and the time, not your kit. The entry banner says <code>⚔ PvP IS ENABLED HERE</code> before you start. <strong>Magma Palace is peaceful.</strong>',
      },
      {
    ...
    notes: [
      ...
      '<strong>Magma Palace</strong> — HARD, 6 badges, <strong>4 keys</strong>, and <strong>PvP is on here too</strong>. <strong>Ender Palace</strong> is still being built.',
      '<strong>3 runs a week for every rank.</strong> Gems buy up to three of them back, at 100 → 200 → 400.',
      '<strong>Friendly fire is off between party members.</strong> A rival party can still invade and sabotage your run — a teammate can no longer knock you into the fire mid-boss.',
      'Scripted bosses <strong>scale with your party size</strong> — roughly 0.67× solo up to 2× for a full four — and so do the adds they summon.',
      'A dungeon death keeps your <strong>equipped accessories</strong> in the body with everything else; they come back through Recovered Gear rather than dropping at the boss.',
  ...
  skills: {
    ...
    notes: [
      ...
      'Netherite is the only gear tier gated behind attributes: <strong>armour needs Vitality 10</strong>, a sword or axe <strong>Strength 10</strong>, and a pickaxe, shovel or hoe <strong>Strength 8</strong>.',
    ],
  },
  ...
  pvp: {
    ...
    intro:
      'Season 2 makes PvP part of progression with a redesigned Ranked ladder. Climb the Ball tiers by winning, then fight for one of just ten Master Tier spots. Outside ranked, the <strong>Warzone</strong> is a bounded free-for-all arena in its own world — walk in and everyone there is fair game.',
    how: [
      {
    ...
    commands: [
      ...
      { cmd: '/warzone', desc: 'Open the Warzone hub — enter the arena, check your Warzone Points and the shop (also /wz)' },
    ],
    notes: [
      ...
      'The <strong>Warzone</strong> is a bounded arena, not the old open world — flight is blocked inside it, and a win pays <strong>25 Warzone Points</strong> (a loss still pays 3). Spend them in the Warzone shop, where an Orb costs 400 WP, up to 20 Orbs a week.',
      'Losing a Warzone battle does <strong>not</strong> take your Pokémon — and the 750,000-coin Steal Protection that insured against that has been removed rather than left on sale.',
    ],
  },
  ...
  breeding: {
    ...
    how: [
      ...
      },
      {
        ...
        body:
          'Destiny Knot passes 5 IVs, power items pin a specific stat, <strong>regional forms pass from the species parent with no Everstone needed</strong> (an Everstone still wins when one is held, and still passes the nature), and the Masuda Method still boosts shiny odds. Egg moves come from the father or a benched parent, Poké Ball is inherited, and babies can inherit a parent’s size. Light Ball on a parent gives your bred Pichu Volt Tackle, and a Mirror Herb teaches an egg move between incompatible parents. Manaphy breeds Phione, Nidoran and Volbeat/Illumise roll correctly, and baby forms hatch as babies.',
      },
      {
        title: 'Ditto × Ditto',
        body:
    ...
    notes: [
      ...
      'A ranch banks up to <strong>3 eggs</strong> at a time, and a bred Pokémon’s ability updates correctly when it evolves — Hidden Abilities included.',
    ],
  },
  ...
  bingo: {
    ...
    how: [
      ...
      },
      {
        ...
        body:
          'Catch any species shown on your card and that square fills automatically — and each square you mark pays <strong>8,000 Coins + 1 Token</strong> on the spot. No need to manually match; the card tracks your catches as they happen.',
      },
      {
...
const COMMANDS = [
  ...
  },
  {
    ...
    items: [
      ...
      { cmd: '/legend roll', desc: 'Spend your bar on the Legendary roulette — costs 10 Orbs a spin; a full bar is guaranteed, from 20% up it\'s a gamble (alias /legend spin)' },
...
const PATCHNOTES = [
  ...
  },
  {
    date: '2026-09-15',
    tag: 'Patched',
    title: 'The Synthesizer stops eating your fusions, Wonder Trade stops handing out Aurelions, and the ranked banlist catches up',
    changes: [
      { type: 'fixed', text: '🧬 <strong>The Paradox Synthesizer was consuming fusion and special-form Pokémon as if they were ordinary ones.</strong> Reported by slaine6729. It matched your sacrifice by <em>species</em> alone, so a <strong>Queen Gardevoir</strong> counted as “a Gardevoir” for Iron Valiant and was eaten — and the same was true of every recipe base, of the Aurelion sacrifices (Dusk-Mane, Dawn-Wings and Ultra Necrozma) and of a plate-form Arceus. Only a Pokémon in its <strong>standard form</strong> can be sacrificed now, and holding a special form says so <em>before</em> anything is consumed: <em>“Your Gardevoir is in its queen form — only a standard Gardevoir can be sacrificed.”</em> A plated Arceus adds <em>“Take its Plate off first.”</em> Both the client screen and the chest menu show the requirement up front instead of letting you find out afterwards.' },
      { type: 'fixed', text: '🎁 <strong>Wonder Trade could hand out an Aurelion — and you could throw one in.</strong> Both halves are closed. The pool filtered its rolls using Cobblemon’s own legendary and mythical flags, which our custom species simply do not carry, so <strong>all eleven customs on the server</strong> — Aurelion, the seven SolForge forms and the three Crythian — were eligible to be generated. One player received an <strong>Aurelion Lv.52</strong> from <code>/wt</code> on Sep 13; it was recovered and compensated. Separately, nothing stopped you <em>depositing</em> one, which would have handed a bought Aurelion to a random stranger and walked straight around the Gems-only lock those species carry on the GTS and in <code>/trade</code>. Custom species are now rerolled out of the pool <em>and</em> refused at the deposit screen, with nothing taken.' },
      { type: 'fixed', text: '✏️ <strong><code>/pe</code> could edit the wrong Pokémon when your party had a gap in it.</strong> The picker listed your party with empty slots skipped, then resolved your click against the raw slot number — so with a hole in the middle of your party, clicking the last Pokémon either did nothing at all or opened, and charged you for, a <em>different</em> one.' },
      { type: 'improved', text: '⚔️ <strong>The ranked banlist has caught up with the Mega Showdown update.</strong> Around forty <strong>Legends Z-A Mega Stones</strong> arrived on the server on no banlist at all, which quietly made Mega Metagross and the entire Z-A set legal in NatDex OU — they are banned now. <strong>Walking Wake</strong> is banned in Singles to match Showdown’s own Uber listing, and <strong>Medichamite</strong> is unbanned outside OU, where Showdown has it at UUBL. The list stands at <strong>78 banned species and 44 banned items</strong>, and the Warzone reads the same one.' },
      { type: 'improved', text: '🗝️ <strong>Dungeon boxes: the SolForge Key line pays, and the Reliquary is reachable.</strong> The top box’s “SolForge Key” was being granted through a route that could never find that crate, so for two days it silently paid nothing — if a Reliquary owes you one, ping staff and it will be handed over. Separately the Reliquary’s speed gate moved <strong>600 → 900 seconds</strong>: of six measured clears only one came in under ten minutes, so the best box was effectively Magma-Palace-only. Its rarest lines were trimmed in the same pass — shiny legendary and shiny mythical <strong>20% → 8%</strong>, shiny and perfect-IV <strong>20% → 10%</strong>.' },
    ],
  },
  {
    date: '2026-09-12',
    tag: 'Season 2',
    title: 'Cobblemon 1.8 is live — a new client pack, a Pokédex that survives it, and dungeon boxes that finally have loot',
    changes: [
      { type: 'new', text: '❄️ <strong>The server now runs Cobblemon 1.8.0.</strong> This is the biggest single update of the season and it is not optional: <strong>you need the CobbleAsia S2 pack 2.1.0</strong>, because a client still on the 1.7.3 pack is refused at the door. Grab it from Discord — the install guides in <b>#how-to-install</b> were rewritten for it. 1.8 brings alpha Pokémon (they lead herds, always know a TM move and adapt to your party), fossils that generate more naturally, a brewable Ability Capsule, and a great many new species and spawns.' },
      { type: 'fixed', text: '⚠️ <strong>Cobblemon advancements were reset by the update, and this one is not ours.</strong> Cobblemon 1.8 removed <strong>46 of its own advancements</strong>, and the game discards saved progress for anything whose id no longer exists — so every Cobblemon advancement except the root one is gone, including <em>first catch</em>, <em>first shiny catch</em>, <em>first battle victory</em>, <em>first evolution</em>, <em>full party</em>, <em>obtain all berries</em> and <em>craft all balls</em>. <strong>It cannot be restored</strong>, because the ids to re-grant no longer exist. Recipe unlocks are unaffected, and nothing else moved — your Pokémon, Pokédex, money, gear, homes and ranks are all untouched.' },
      { type: 'fixed', text: '📖 <strong>Your Pokédex kept counting through the update.</strong> 1.8 renamed the internal constants every dex write goes through, which would have silently zeroed <code>/shinydex</code>, <code>/regiondex</code> and every dex-backed rank requirement the moment the server restarted — a rank you had already earned would have stopped being met. Both the crate rewards and the rank sync now resolve those by name, so nothing was lost.' },
      { type: 'fixed', text: '🔁 <strong>Wonder Trade moved in-house — and then didn’t work at all for nine hours.</strong> Picking a Pokémon opened the “are you sure?” screen, and that screen crashed before it could be sent, so nothing appeared and the trade never started: <strong>13 crashes and 0 completed trades</strong>. Three people said so in public chat and nobody opened a ticket, which is the only reason it took as long as it did. <strong>You did not lose anything</strong> — the failure landed before the trade itself ran, so no Pokémon was taken and no cooldown was spent. <code>/wt</code> has been trading normally since.' },
      { type: 'new', text: '📦 <strong>The dungeon reward boxes have loot in them.</strong> The three paid boxes were shipped with empty tables, so a Reliquary was priced like it had a prize list and paid shards and pool rolls like the free one. vj’s three loot columns are now in, as <strong>13 independent lines per box</strong> — coins, Tokens, Bottle Caps, Nature Modifiers, HA Tokens, SolForge armour and a SolForge Key — with one guaranteed line on the Reinforced Cache, and percentages tunable in game rather than needing another update.' },
      { type: 'fixed', text: '🎣 <strong>The Solar Current poké-rod was auto-farming relics on reels that caught nothing.</strong> Reported by samsonmaniac: holding right-click harvested Sunken Relics and Ancient Sun Caches without ever catching anything. The check for “did this reel bring up an item” was answering <em>yes</em> on every cast, including empty ones — the field it read is set the instant the bobber is created, not when something is caught. The vanilla-rod half was never affected, and a real catch still pays exactly as before.' },
      { type: 'improved', text: '🧑‍🌾 <strong>Villagers can breed again, without turning terrain damage back on.</strong> Asked for in the suggestions forum by _318k and k.kairyy. Villagers only become willing to breed by <strong>picking food up off the ground</strong>, and vanilla gates <em>all</em> mob item pickup behind one global rule that we keep off on purpose — it is the rule that stops creepers and endermen wrecking builds. Villager pickup and villager farming are now answered separately, so the food loop works and nothing else changes.' },
      { type: 'improved', text: '⚔️ <strong>Tera is legal in AG Singles</strong>, which was the actual point of Anything Goes and the reason it was asked for. OU and Ubers Singles still ban it; every Doubles format still allows it. A related bug went with it: leaving an arena match used to re-queue you into <strong>OU</strong> no matter which tier you had queued for. 👁️ Separately, <strong>Area Zero bosses now wear 1.8’s glowing red alpha eyes</strong> — cosmetic only, no stat change, and if you catch one you keep the mark as a trophy.' },
    ],
  },
  {
    date: '2026-09-11',
    tag: 'Voting',
    title: 'Voting gets a pity ladder, dungeon runs are counted per dungeon, and brewing finally pays Alchemy',
    changes: [
      { type: 'new', text: '🗳️ <strong>The vote crate has a pity ladder.</strong> Voting paid a flat crate with no floor at all, so a long unlucky streak paid for itself in nothing. There are now three rungs: <strong>100 votes</strong> pays 5 Vote keys, 1 Origin key, 1 Legacy key, 100,000 coins and a <strong>10%</strong> shot at a Legendary Spin; <strong>200 votes</strong> pays 5 / 2 / 2, 250,000 coins and <strong>25%</strong>; <strong>300 votes</strong> pays 5 / 5 / 5, 500,000 coins and a <strong>guaranteed</strong> Legendary Spin, then resets the ladder. <strong>Your past votes count</strong> — every voter was seeded from their lifetime total the day it shipped, and seventeen players collected immediately.' },
      { type: 'improved', text: '🏰 <strong>Dungeon runs are now counted per dungeon: two each, instead of three a week across everything.</strong> Measured before it was built — <strong>133 of 154 clears this season were Magma Palace</strong>, which was the menu rather than a preference, because a flat weekly budget is always spent on the one dungeon you like most. Your free runs are now <strong>2 × the dungeons you can actually enter</strong>, so it rises by itself as you rank up and as dungeons open. Bought runs and key runs are unaffected and still go anywhere.' },
      { type: 'fixed', text: '⚗️ <strong>Brewing a Cobblemon recipe paid no Alchemy XP at all.</strong> Reported by de4th6767. Cobblemon brews its own recipes without going through the vanilla brewing step, which is exactly where our XP credit lived — so <strong>all 26 Cobblemon brews</strong> paid nothing: every Potion and Full Restore, <strong>all six vitamins</strong>, PP Up and PP Max, Ethers and Elixirs, Medicinal Brew and Throat Spray. Vanilla potions were always fine. Credit now happens at the brewing stand itself, so both kinds pay.' },
      { type: 'fixed', text: '👻 <strong>Invisible Pokémon.</strong> Reported by ra1zuuu for a Landorus-Therian that simply did not appear when sent out. The model was never the problem — the Pokémon had a <strong>saved size of 0.0</strong>, written by a Dynamax revert reading a size key that was not there. Any Pokémon in your party or PC carrying a broken size is repaired to normal when you join, and our own half of the cause is gone.' },
    ],
  },
  {
    date: '2026-09-10',
    tag: 'Dungeons',
    title: 'A dungeon clear pays a box you choose, the Battle Tower stops lying about your Pokémon, and two live crashes are closed',
    changes: [
      { type: 'new', text: '📦 <strong>Clearing a dungeon no longer pays a pile of coins — it pays a box you choose.</strong> Asked for in the Staff Dungeons Revamp thread. The flat coins, Tokens, free Orb, two free seasonal rolls and free 10% SolForge part roll have all moved <em>inside</em> four tiers you pick between at the end of a run: <strong>Scavenged Cache</strong> (free), <strong>Reinforced Cache</strong> (200,000), <strong>Gilded Vault</strong> (400,000) and the <strong>SolForge Reliquary</strong> (900,000, and only offered on a fast clear). The hub also shows your <strong>weekly run budget</strong> for the first time — it had been showing a different counter entirely — and the gem buy-back for extra attempts finally has a button instead of only being mentioned in the refusal you see after running out.' },
      { type: 'improved', text: '🏯 <strong>The Battle Tower pays properly, and the first floors stop opening against fusions.</strong> Measured off the real ladder: <strong>55 of the 111 players who have started Season 2 had never cleared floor 1</strong>, and the median best floor was 1 — the old payout ramp put its money at depths nobody reaches, so a typical run earned <strong>12 Tokens</strong>. Payouts are up roughly threefold and the in-run shop is reachable. Separately, <strong>floor 1 had a 48.8% chance of fielding an authored fusion</strong> — whole elite teams were correctly gated to floor 10 but the per-slot sprinkle never was. And client-mod users can finally <strong>buy a Revive</strong>: the chest menu had the button and the custom screen never did.' },
      { type: 'fixed', text: '🏯 <strong>The Tower stops lying to you about where your Pokémon went.</strong> Two reports from zenisdead_. Adding a Pokémon to your party mid-run <strong>silently sent it to your PC</strong> — a run only ever fights the team you drafted, so the pre-battle heal benched it with nothing but a line in the server log; it happened to him four times in one day and he fought floor 10 short-handed. And a restore that failed to find your Pokémon still announced that all of them had been returned. Both now say what actually happened, and the draft picker — which silently refused to open for client-mod users with a large PC — opens.' },
      { type: 'fixed', text: '💥 <strong>Two live server crashes, from the same mistake in 21 places.</strong> Engaging a dungeon boss removed entities while walking the world’s list of them, which corrupts the walk itself — it took the server down twice on Sep 9. The pattern was fixed everywhere it appeared, across dungeons, essentials and the Safari, where it had also been quietly abandoning the cleanup sweep halfway through.' },
      { type: 'improved', text: '💊 <strong>An Ability Capsule that cannot do anything now tells you why.</strong> Re-reported as “still broken” on normal Pokémon. It isn’t: a Capsule swaps between a species’ <em>common</em> abilities, and a species with only one has nothing to swap to — Salamence, for instance, has Intimidate and Moxie as its hidden one, so the Capsule is a correct no-op and the <strong>Ability Patch</strong> is the item that does something. It says so now instead of appearing to fail.' },
      { type: 'fixed', text: '📕 <strong>Book and Quill authoring is disabled server-wide</strong>, on exploit and crash-risk grounds, alongside removing its crafting recipe. Books you already have are untouched and still readable. 🕳️ In the same window: <strong>falling into the void in Area Zero is a death now, not a free escape</strong> — a rescue meant for a completely different bug was catching AZ players 59 blocks above the void kill and teleporting them to spawn with everything they were carrying.' },
    ],
  },
  {
    date: '2026-09-08',
    tag: 'Quality of Life',
    title: 'The daily buff stops deleting your potions, a dungeon party stops charging the members it leaves behind, and box legends stop leaking into the free Legend bar',
    changes: [
      { type: 'fixed', text: '🧪 <strong>The daily server buff was deleting your own potions.</strong> It removed and re-added its effect for every online player every few seconds — and a remove cannot tell its own buff from the Speed II you just drank, so your potion was stripped and downgraded to the buff’s weaker version within five seconds of drinking it. The remove was never necessary in the first place: the game already refreshes an effect correctly, and it even stores a weaker-but-longer buff underneath so it comes back when the stronger potion runs out. Not an Area Zero bug, though that is where it kept being noticed.' },
      { type: 'fixed', text: '🏰 <strong>Starting a dungeon as a party could charge members it then left behind.</strong> Each member was checked and charged one at a time, so if one of you was over the totem or god-apple limit, <strong>the rest were charged a weekly run and warped in without them</strong> — and there is no refund path. The whole party is validated before anyone is charged now.' },
      { type: 'fixed', text: '🐉 <strong>Box legendaries were leaking into the free Legend bar.</strong> The bar is meant to exclude them and the code that does it was correct — but Zacian, Zamazenta and Calyrex were arriving from an add-on mod with the “restricted” marker <em>stripped off</em>, so they read as ordinary legendaries and sat in the free pool at full weight. They are pinned by identity now rather than by a marker another mod can delete.' },
      { type: 'improved', text: '🔑 <strong>The Shard-Shop Dungeon Key no longer bypasses the weekly run budget without limit</strong> — it had no purchase cap at all, so the cap that makes runs scarce could simply be bought around. 🥊 And a gym battle interrupted by a crash used to leave your whole party stranded at that gym’s level cap with no record of the real levels; that is now visible and reported instead of silently sticking.' },
      { type: 'improved', text: '☀️ <strong>Solar Ascension was handing back the wrong Pokémon entirely.</strong> Every SolForge target was being looked up under a name that does not exist, and the fallback for “no such species” is a <em>random</em> one — so the forge had never once worked, on any restart, since it shipped. Nine consecutive attempts by one player produced nine unrelated Pokémon. Fixed, with a start-up check that now confirms all seven SolForge targets resolve before anyone can spend a shard.' },
    ],
  },
  {
    date: '2026-09-03',
    tag: 'Patched',
    title: 'Orbs get a real income, the big dungeon bosses can finally hit you, and a bounty stops printing money',
    changes: [
      { type: 'new', text: '🪙 <strong>Orb income is retuned across the whole server, and raids pay Orbs for the first time.</strong> Orbs are the Season 2 summon currency and almost every faucet moved at once: <strong>Daily Commissions 1 → 5 Orbs</strong> and <strong>Weekly Commissions 3 → 15</strong> (50 a week from the board alone, up from 10), the <strong>Battle Tower</strong> and <strong>Warzone</strong> shops both go from <strong>10 → 20 Orbs a week</strong>, and <strong>raid bosses now pay 1–3 Orbs by rarity</strong> with <strong>+1 to whoever dealt the most damage</strong>, capped at 15 a week. Raids were the last major group activity minting nothing. Buying Orbs with coins runs at <strong>25,000 coins each, 15 a day</strong> — the grant faucets carry the bulk of the new income deliberately, because any coin price low enough to buy a month of Orbs would make coins worthless for everything else they pay for.' },
      { type: 'new', text: '🎯 <strong>Name the 5★ you’re chasing — and pity now survives a rotation.</strong> On a group banner you can pick which featured legendary you want, and a 5★ award lands on that one instead of rolling across the five to eight members. The <strong>0.2% base rate, the 205/250 pity ramp and the 50/50 are all untouched</strong> — a target changes <em>which</em> 5★ you get, never how often. Separately, and worse: pity was keyed per banner, so <strong>every rotation stranded your counter</strong> — 180 pulls into one banner went to zero the moment the next opened, while the rates panel promised the opposite. All rotation banners now share one pity pool, existing counters were folded together taking the best of each, and the 50/50 guarantee carries too.' },
      { type: 'fixed', text: '💰 <strong>An Area Zero bounty was a money printer.</strong> Reported by staff: put 100k on someone, kill them yourself, and walk away with 150k. Bounties are funded by players at face value but were paid out through the <strong>server-reward door</strong>, which applies your donator coin boost — so every place-then-claim cycle minted your rank percentage out of nothing, as fast as two accounts could trade kills. The pot now leaves through two doors: <strong>the half other players funded pays unboosted</strong>, and the spree/hunt bounty the server minted itself still pays boosted, because the boost is correct for that half. A normal claim pays exactly the headline number it always did.' },
      { type: 'improved', text: '🗡️ <strong>The biggest dungeon bosses could never land a hit — and now they can.</strong> Eight separate pursue-and-melee loops measured reach <strong>centre to centre</strong> against a constant tuned for a player-sized mob, while scripted bosses spawn at 1.8–2.8× scale and Cobblemon scales the hitbox with the model. The largest ones had a body wider than their own reach — collision held you at the hitbox edge, already outside the range test. The <strong>Colossus and his Giants, the Warden, the Rayquaza pillar boss and the Sentinel</strong> were all melee-inert for the same reason, and it read as “they’re passive” because <em>your</em> reach is measured to the edge, so they were trivially hittable while physically unable to hit back. Reach is now measured from the body. ⚠️ <strong>This is a difficulty increase, not just a bug fix</strong> — Colossus in particular is a real fight for the first time, and a landed swing now carries knockback. Jester balloons throw you too.' },
      { type: 'new', text: '👥 <strong>Dungeon bosses scale with your party.</strong> Every scripted boss and its adds now run a headcount curve — <strong>0.67× solo, 1× duo, 1.5× trio, 2× for four</strong> — so a configured HP pool is the two-player number rather than an absolute. Headcount is a high-water mark that only rises, so tagging a boss with the clan and then soloing a shrunken pool doesn’t work, and a party that grows mid-fight grows the pool by the difference so damage already dealt stays dealt. The <strong>Jester now throws one balloon per fighter</strong> instead of one for the whole party — three of a four-stack could previously ignore the mechanic entirely.' },
      { type: 'fixed', text: '💍 <strong>A dungeon death put your armour in the body and dropped your rings at the boss.</strong> The corpse system exists so a dungeon death costs you nothing, but it only ever knew about vanilla slots — equipped accessories live in the accessories mod’s own containers, so they were never snapshotted and never cleared, and that mod’s death handler scattered them where you fell. Reported after an <strong>Omni Ring</strong> was lost. Accessories are now stripped into the corpse in the window before they can drop, and come back through the same Recovered Gear delivery as everything else.' },
      { type: 'fixed', text: '🚪 <strong>Adding an area to a boss-rush dungeon sealed its finale permanently.</strong> Holding all four keys, every hit on the final boss still answered “Sealed — clear the dungeon’s objectives first.” The damage gate was checking per-player <em>area</em> keys while boss-rush runs earn <em>shared run slots</em> — two different currencies — and nothing on a boss-rush run can grant an area key past the first, so the second area minted a requirement with no issuer. Deterministic and permanent, not a rare race. The gate now defers to the same key check the boss fight itself runs, so the two can no longer disagree. <strong>Ender Palace would have failed identically</strong> the first time anyone reached its finale.' },
      { type: 'fixed', text: '🏟️ <strong>Bosses teleporting to nowhere, arenas bouncing you mid-fight, and a spawn leak nobody reported.</strong> Three separate dungeon faults: a boss slot whose arena was never configured read as <code>0,0,0</code> — <strong>world origin</strong> — so regigigas and rayquaza were being flung hundreds of blocks the moment they moved; an unconfigured arena is now left alone instead. The soft band inside every room seal applied an inward shove <strong>with an upward hop, every tick</strong>, so fighting near the rim meant being bounced continuously; it now only pushes someone actually moving outward, with no hop. And a boss-rush run was quietly spawning <strong>an L100 alpha every four seconds into an unloaded chunk</strong> — 145 of them in ten minutes — because the keep-alive count can only see loaded chunks and kept topping up a marker 600 blocks from where the party was standing.' },
      { type: 'improved', text: '🌋 <strong>Magma Palace has PvP on too.</strong> The 27 August note said it was peaceful; as of now it is not — <strong>both open dungeons are PvP zones</strong>. Solforge Nexus (INSANE, 8 badges, Ace rank, 4 keys) and Magma Palace (HARD, 6 badges, 4 keys) can each be invaded by another party. Ender Palace is still being built. And <strong>friendly fire is off between party members</strong> in all of them — the spec was always “other parties can sabotage your run”, but the gate keyed on the arena alone, so a teammate could knock you into the fire mid-boss. Both the melee and the arrow/potion path refuse a same-party hit now; a player from a different party in the same room is still hostile.' },
      { type: 'fixed', text: '🏆 <strong>A Battle Tower run survives a client crash.</strong> Crash on floor 12 and you came back on floor 1 — a mid-battle disconnect ended the run, while a between-floors one already preserved it. It could not simply be switched on, because the opponent is generated fresh at every battle start: preserving the run alone would have re-opened the <code>/endbattle</code> re-roll closed last week, and made pulling the plug <em>strictly better</em> than a command. So the trainer is <strong>pinned to a seed stored on the run</strong> — a resumed floor regenerates the identical fight, never a new one — and it is allowed <strong>once per run</strong>. <code>/endbattle</code> and forfeit still end the run immediately.' },
      { type: 'fixed', text: '🥚 <strong>Regional forms breed true without an Everstone, and a bred Pokémon’s ability updates when it evolves.</strong> Breeding a Galar Slowpoke gave a Kanto Slowpoke: form inheritance sat entirely behind an Everstone check, so with no Everstone held the whole block was skipped and the baby hatched base form. That was Gen-7 rules on a Gen-9 server — mainline dropped the Everstone requirement from SwSh onward. The species-donating parent passes the form now, and <strong>an Everstone still wins when one is held</strong>. Separately, every bred Pokémon’s ability was <em>frozen for life</em>: the hatch pinned it as “forced”, and a forced ability is never re-resolved on evolution — so a bred Darumaka kept Hustle as a Darmanitan, and a bred Trapinch kept Hyper Cutter as a Flygon. Abilities now carry across evolution properly, <strong>Hidden Abilities included</strong>.' },
      { type: 'new', text: '🐣 <strong>A ranch holds three eggs, not one.</strong> Asked for as a paid <code>/passive</code> upgrade; shipped free for everyone instead — the egg trays were always built for seven slots, and the only thing holding a ranch to one egg was a config number. Also fixed: <strong>sneaking with an empty hand opened the vanilla pasture screen</strong>, so a pasture behaved as a ranch and a vanilla pasture at once. Don’t park Pokémon through that screen — adopting the ranch releases anything tethered in one.' },
      { type: 'fixed', text: '⚡ <strong>Mega evolving a Hidden Ability Pokémon and reverting stripped the HA — and it was our own protection doing it.</strong> The sweep that pins a Hidden Ability so it survives a save also <em>un-pins</em> any Pokémon whose form lists the same ability in both the regular and hidden slot — a correct rule, written for Ogerpon masks. But it read the form the Pokémon was wearing <em>right now</em>, and <strong>all twelve mega forms that declare abilities duplicate them across both slots</strong>. So every mega evolution outside battle looked exactly like an Ogerpon mask and had its pin stripped, permanently. It now tests the species’ <em>standard</em> form. ⚠️ The watcher we shipped to catch this was blind for the same reason — five days of zero alerts was never evidence it wasn’t happening.' },
      { type: 'new', text: '🏠 <strong>Returnee’s Quest — come back after two weeks and get paid for five days.</strong> Been away <strong>14+ days</strong>? <code>/returnee</code> pays a step a day for five days, one every 20 hours — coins, keys and a Battle Pass level, weighted toward catching up rather than power. Three gates keep it from being a reason to <em>take</em> a break: you must have been <strong>Ace rank with 10 hours played before the absence</strong>, it pays across five separate days so one login collects a fifth, and there is a <strong>60-day cooldown</strong> between runs.' },
      { type: 'new', text: '⛏️ <strong>Permanent Haste in <code>/passive</code>, and donator ranks finally do something at Guardian.</strong> Haste I / II / III at 300k / 600k / 1.2M coins, or 1,200 / 2,400 / 4,800 Tokens. And each donator tier you have reached now raises your <strong>combined passive cap by one</strong> at Explorer and Guardian — taking a base 3 to 4, then 5. Guardian was on that list deliberately: it was the rung that granted no new command at all. This raises the ceiling; it grants no tiers, skips no content and sells no power — you still buy every passive at full price.' },
      { type: 'fixed', text: '🎲 <strong>Marking a Bingo cell paid nothing — twelve of a card’s sixteen catches were worth zero.</strong> Nine per-cell reward values sat in the config and <strong>not one of them had a single caller anywhere in the codebase</strong>; only the fourth cell of a row registered anything, through the row bonus. The grind felt unrewarded because it was. A marked cell now pays <strong>8,000 Coins + 1 Token</strong> the moment you catch it, named on the same chat line as the mark — a full card moves from 600,000 to about 728,000 coins, with the extra paid as you play rather than in four lumps. Separately, a completed <strong>row was paying 1 Legend Energy instead of 20</strong>, and a full card 10 instead of 150: the live values had drifted from the intended ones with nothing recording why. Both restored.' },
      { type: 'fixed', text: '🔮 <strong><code>/legend</code>’s Training row could never move, and the bar now says what it cannot give you.</strong> Training’s energy cap was <strong>1,250,000</strong> where every other category sits between 150 and 1,500 — 833× its peers — so the row rendered <code>+0.0%</code> and a bar that never visibly moved, no matter how much Training you did. It reads as a <code>_000</code> typo and is now <strong>1,250</strong>. The screen also states outright that <strong>box legendaries never come from the bar</strong> — a player lost two weeks hunting a Zamazenta the bar structurally could not give them — and it names the route that does work: a <strong>Legendary Core</strong> can still roll them. And when a cap or the daily budget swallows an energy grant, we no longer announce “+20 Legend Energy” over a bar that did not move.' },
      { type: 'new', text: '🎰 <strong>Every <code>/legend</code> spin now costs 10 Orbs.</strong> The bar was free to spend, so the only thing between a player and a personal legendary was time. The fill still decides the <em>odds</em> — 20%, 50% or a full 100% — the Orbs buy the spin itself. Charged only once the spin is committed, and <strong>refunded with your bar if the legendary cannot materialise</strong>. A genuine miss keeps them, and the message says so rather than leaving you to work it out.' },
      { type: 'fixed', text: '📜 <strong>SolForge titles render again.</strong> The Archaeologist kept selling twelve SolForge titles for Sunken Relics — granting the permission, taking the relics — while <code>/title</code> draws from a registry those titles had been <em>pruned</em> from since June. Relics spent, permission real, title invisible; one player lost <strong>60+ Sunken Relics</strong> across two purchases. They are re-seeded as <strong>prestige</strong> titles, which is this engine’s word for “earned, never sold”, so they render and can never reappear in the title shop. The Archaeologist now reads that same registry before it will charge anyone, so a title the game cannot show can no longer be sold. <strong>11 of 12 are claimable on live.</strong>' },
      { type: 'fixed', text: '🛡️ <strong>An op could kill you in spawn, and you could not respawn.</strong> The staff PvP bypass ran <em>before</em> every world and zone check, so it reached into protected spawn — where nobody else can hit you and the victim has no recovery. It now falls through to the same rules as everyone else when the victim is standing somewhere protected, rather than refusing outright, which would have locked staff out of Boss Rush PvP entirely. Every legitimate staff PvP surface still works. ⚠️ The death-lock itself is still unexplained; this closes the route that produced it.' },
      { type: 'fixed', text: '🗺️ <strong>3,443 stray armor stands were making the old spawn unplayable.</strong> A leaderboard hologram is eleven invisible armor stands, and both of the paths that remove one <strong>can only see loaded chunks</strong> — so for a pillar nobody had loaded, every 300-second refresh silently failed to remove the old one and spawned eleven more on top. That is about 12,700 new entities a day, saved into the region file and surviving restarts. One pillar was carrying <strong>191 duplicate copies of itself</strong>, and players walking into that area reported <strong>3 fps</strong>. Holograms no longer spawn into an unloaded chunk, and staff have a sweep command for the backlog.' },
      { type: 'fixed', text: '🔗 <strong>The Creation Chain could be placed as a block — and then it was gone.</strong> The Chain’s carrier item is <code>minecraft:chain</code>, a block item, and its right-click handler only ever runs for a click into <em>air</em>. Aim at a block face and vanilla placed it first: the stack decremented, a plain chain went into the world, and the relic rode away on an item that no longer existed. Breaking the block back gives an ordinary chain. Three were lost. Placement is now refused outright rather than treated as a use — a sneaking right-click forges the Azure Flute and consumes the Chain, so guessing at an ambiguous click would trade a silent loss for an accidental irreversible spend. The Charged Star and the Azure Flute were never affected.' },
      { type: 'fixed', text: '👊 <strong>Iron Hands fought the opening of every raid on its natural learnset — Detect included.</strong> Third pass at this report, and the cause was the baseline: a raid starts at <strong>phase 0</strong>, the phase-moveset lookup is 1-based, so at phase 0 it returned an empty list — which means “no override”, which for a boss with no configured moves means <strong>whatever Cobblemon generates</strong>. Awakening is applied once, when the battle is built, so every player who engaged before the boss dropped below 75% HP fought that roster for their entire fight. In a shared-HP raid that is the whole opening. The baseline now uses phase 1’s authored moveset as its floor; the escalation at 50% and 25% is unchanged.' },
      { type: 'improved', text: '⚒️ <strong>Skills: netherite gates lowered and the curve cut by about 2.5×, with past grinding re-credited.</strong> A full netherite kit needed <strong>32 attribute points</strong> against a server median of <strong>2</strong> — the entire p50–p90 band sat under the gate, so it paced nobody. Netherite armour is now <strong>Vitality 10</strong>, sword and axe <strong>Strength 10</strong>, pickaxe, shovel and hoe <strong>Strength 8</strong>. One attribute point by mining alone drops from roughly 12,300 blocks to 4,800 — about six hours of grinding down to two and a half. <strong>Every stored profile was re-levelled from its lifetime XP under the new curve</strong>, so the hours you already put in count; the pass only ever raises a level, never lowers one.' },
      { type: 'fixed', text: '🏷️ <strong>Warzone was selling 750,000-coin Steal Protection against a mechanic that no longer exists.</strong> Losing a Warzone battle has not taken your Pokémon for two months, so the insurance protected against nothing. It is off the shop. Also in the Warzone: <strong>dens stopped spawning on rooftops</strong>, flight is blocked inside the zone, and five surfaces that still advertised the legacy flat 25 Warzone Points now quote what you actually earn.' },
      { type: 'fixed', text: '⚔️ <strong>Gym and PvP battles that wedged forever on a forced switch.</strong> When Showdown asks for a <strong>switch</strong> — a KO, Roar, Whirlwind, U-turn, an Eject Button — the recovery path was submitting a <em>move</em>, which cannot satisfy that request, so the turn never advanced and the battle hung permanently. A doubles gym where one side has fewer healthy Pokémon than slots to fill hit it every single time. All three copies of that code now answer with the response the game actually asked for. ⚠️ Not every gym wedge is this one — the remaining cases are still open.' },
      { type: 'improved', text: '📋 <strong>Ranked banlists, and a report we could not answer.</strong> Four species banned in singles were legal in doubles while doubles already banned their <em>weaker</em> forms — Necrozma-Ultra, Terapagos-Stellar, Marshadow and Spectrier are now banned in doubles too (53 → 57). Aurelion and Crythian Garchomp are banned in NatDex OU, and the custom-mon ban that only ever covered singles now covers both. A “banned mon in ranked” report also could not be answered at all, because <strong>nothing recorded which of the three ranked queues the player joined</strong> — and OU enforces species bans while Ubers and AG deliberately do not. The queue logs it now.' },
      { type: 'fixed', text: '🛒 <strong>The shop refused sells over an empty lore, and <code>/checkspawn</code> charged in silence.</strong> “Your Exp. Share carries extra item data, so it doesn’t match the listing” — about a stack the server had itself measured as clean. The catalogue entry carried a lore component with <strong>zero lines</strong> and the player’s stack had none at all, which the game treats as different; three earlier passes went hunting for a mod “decorating” the listing that never existed. Components carrying no information are now ignored, which clears every affected item at once. And <code>/checkspawn</code> printed its price <em>only when you couldn’t afford it</em>, so the only players who ever learned it costs tokens were the broke ones — someone lost about 3,000 tokens across three lookups they believed were free. It says what it took now, every time. The price is unchanged.' },
      { type: 'fixed', text: '🗿 <strong>Area Zero: your overflow goes to <code>/mail</code>, and the cap takes the spare rather than the totem in your hand.</strong> The item cap has to strip overflow in place — ejecting an over-cap player was being used as a free, safe exit — but it dropped it at your feet in an open-PvP zone, so a supply drop you had earned became loot for whoever was standing nearby. It is mailed now, with the ground drop kept as a fallback. Worse, and reported within hours: the sweep walked inventory slots in an order that puts the <strong>offhand last</strong>, so at a totem cap of 1 it kept the backpack copy and took the one you were <em>holding</em>. It sweeps equipped-first now — what you are holding is what you keep.' },
      { type: 'fixed', text: '📄 <strong>Paradox contracts could not be finished in Area Zero, and a weather vote stopped at the overworld border.</strong> Killing paradoxes in the sphere credited <code>/contracts</code> nothing — the code skipped them to avoid double-counting a wild paradox KO, which is true in the open world and false in Area Zero, where bosses run an HP pool and are caught rather than KO’d. That made <code>paradox_kills</code> unachievable in the one place people hunt paradoxes. And a <code>/weather</code> vote applied to the overworld only, so a vote won and paid for from the <strong>resource world</strong> changed nothing where the voter was standing. Weather now reaches every overworld-like world, minus the scripted ones whose atmosphere is authored content.' },
      { type: 'improved', text: '🧪 <strong>The Contract Board guarantee is visible before you lose, and there is a new Cloning Chamber.</strong> Contracts <em>are</em> guaranteed — 15 points of pity per failed attempt means a standard legend is certain on attempt 3 and a box art on attempt 4 — but both shop surfaces hid that line until after your first failure, so players read a guaranteed purchase as a flat 70% gamble and priced their Orbs accordingly. A 110-message thread asked for a feature that had shipped long ago, because the feature never said so. Both tiles show the ladder up front now. New in the Paradox Synthesizer: <strong>sacrifice a Mew, pay 200 Orbs, 25% for a wild Lv 70 Mewtwo</strong> — the first craft in there that can fail, and a losing roll is a completed attempt.' },
      { type: 'fixed', text: '🗃️ <strong><code>/vaultsee</code> could only ever see page 1, and staff edits were fighting the owner’s own vault.</strong> The command had no page argument, so every past “their vault is clean” only ever meant page one — and for donator tiers that start at ten pages, that is exactly the accounts most likely to appear in a dupe or scam claim. It reaches every page now, on offline players too. Both vault screens also write their whole snapshot back on every click without re-reading, so a staff edit and the owner’s open vault raced: the item came back — or, unreported and worse, the owner’s deposit was destroyed. One page can now be open in one place at a time.' },
      { type: 'improved', text: '🔈 <strong>Smaller things.</strong> The profanity filter <strong>muted a player for an hour over a one-key typo of “good luck”</strong>; phrase-shaped exceptions now exist, so the real slur stays blocked. <code>/ascwt ambush off</code> silences your own roadside encounters without nerfing them for everyone else. The Resource World <code>/rtp</code> button finally warns that builds there do not survive a season reset. Dungeons show <strong>proper names</strong> instead of ids like <code>solforge_nexus</code>. Battle Tower shop tiles that were blank — 16 of 59, and exactly the ones people ask about — carry descriptions. And a conceded friendly duel no longer counts toward a ranked Battle Pass quest.' },
    ],
  },
  {
    date: '2026-08-27',
  ...
  },
  {
    date: '2026-08-18',
    tag: 'Patched',
    title: 'Items that were doing nothing, one Elite Four, and the Creation Chain opens',
    changes: [
      { type: 'new', text: '⛓ <strong>The Creation Chain is open — a second road to the box legends.</strong> Right-click your own <strong>Uxie, Mesprit and Azelf</strong> with a plain Nether Star to imprint them, fuse the three Charged Stars into the <strong>Red Chain</strong>, and summon <strong>Dialga, Palkia or Giratina</strong> as a Mythic raid at the Spear Pillar. Beat it and it is <strong>genuinely catchable</strong> for 60 seconds at level 85 — anyone who did 1% of the damage may throw, first ball wins. Clear all three and a spare Chain shift-right-clicks into the <strong>Azure Flute</strong> for Arceus. One Chain per player per week; one imprint per guardian, forever; and guardians must be <strong>self-caught</strong> — a traded one is refused, so check <code>/ascraid chain</code> before you go hunting stars. <a href="feature.html?f=creation">Full walkthrough here.</a>' },
      { type: 'new', text: '🏆 <strong><code>/ladder</code> is one Elite Four now, with a Champion on top.</strong> It used to carry <strong>six parallel ladders</strong> — OU, Ubers and AG, each in Singles and Doubles — for twenty-four seats between them, twenty-three of which had never been held by a player. There is now a single board: <strong>rank 1 is Champion, ranks 2–5 are Elite 1 through 4</strong>, and beating the holder takes their seat. Every seat reset to its NPC holder on this restart, because every rank shifted down one under the new Champion seat — that includes the one player-held seat on the old boards, which we are sorry about. The <strong>ranked queue still runs all six formats</strong>; it is only the throne room that narrowed.' },
      { type: 'fixed', text: '🧬 <strong>Ability Capsules and Ability Patches were doing nothing at all.</strong> Our own anti-revert pin — the thing that stops a Hidden Ability quietly reverting overnight — makes Cobblemon refuse both items outright: <strong>no message, no consumed item, no feedback of any kind</strong>, which is exactly why it read as "the item is broken" and went unreported for so long. The Patch was the real casualty: a <strong>50,000-token</strong> Battle Tower item and Dex-70 reward that was a guaranteed no-op on precisely the Pokémon you would buy it for. A deliberate right-click with a changer now beats the pin, and the pin re-applies within five seconds afterwards — so a successful Patch sticks, and a mis-click heals itself.' },
      { type: 'fixed', text: '🔮 <strong>A traded Deoxys could never change form again.</strong> Delivering a trade pinned the form it arrived in, so the Meteorite fired, set the form, and watched it snap straight back — same silent no-op as above, in a different mod. Trades now restore a form the way the game does, which is durable across a relog <em>and</em> still loses to an item you deliberately use. ⚠️ <strong>Pokémon already traded to you are still pinned</strong> — this only changes how future deliveries are written. Open a ticket with the mon and staff can clear it.' },
      { type: 'fixed', text: '⭐ <strong>Every prestige was crediting half a Star.</strong> A Star costs 100 levels and was being credited as 50, so each one silently cost you about <strong>17 attribute points</strong>, compounding with every prestige — which from the player\'s side looked like "the first 25 levels after a prestige give no points". Attribute points are worked out from your levels rather than stored, so <strong>everyone who has prestiged got their missing points back automatically on this restart</strong>. Nothing to claim, nothing to ask for.' },
      { type: 'fixed', text: '🗄️ <strong>The vault was refusing every enchanted, named or damaged item.</strong> The part that writes an item\'s extra data and the part that reads it back disagreed by two bytes, so every stored blob read back empty and the vault\'s own safety check — correctly — refused to store anything it could not round-trip. <strong>Nothing was ever lost; it was unstorable</strong>, and items already in the vault get their names, enchants, damage and lore back on the next load.' },
      { type: 'new', text: '🐄 <strong>More ranches, buyable three ways.</strong> The limit of 3 ranches is now a floor rather than a ceiling: each <strong>Ranch Slot</strong> permanently adds one, and they stack. Buy them with coins in <code>/passive</code> (the price doubles each time, starting at 500,000), or for a flat <strong>2,000 Tokens</strong> in either <code>/shop</code> or the Battle Tower shop. <code>/ascbreed info</code> shows your personal limit and how many you have bought.' },
      { type: 'improved', text: '💼 <strong>The job boards were showing you every quest they had.</strong> A board has 3 daily slots and 2 weekly ones; most jobs owned exactly 3 dailies and 1 weekly — so the "rotation" shuffled a pool and handed back all of it, and you saw the same board every day. It was worse for new players: an <strong>Apprentice saw 2 of 3 daily slots filled on 7 of 9 jobs</strong>, because a tier only ever draws quests at or below it. <strong>63 new quests, 36 → 99</strong>, so every board is full and genuinely rotates at every tier — and <strong>Master</strong>, which had no exclusive quests anywhere, now has one per job. Payouts are unchanged at 25,000 a daily and 125,000 a weekly; this adds variety, not income.' },
      { type: 'fixed', text: '🥚 <strong>An Everstone finally passes a regional form to the baby.</strong> Breeding an Alolan or Galarian parent with an Everstone gave you the base form every single time — the egg recorded the form\'s name and the hatch had no way to apply it. Regional forms now inherit, and the baby\'s ability is rolled from <strong>its own</strong> regional pool, so an Alolan Vulpix hatches with a Snow Cloak or Snow Warning roll rather than a Kantonian one. ⚠️ <strong>Eggs already sitting in a ranch were created without it and still hatch base form</strong> — new eggs carry it.' },
      { type: 'improved', text: '⚖️ <strong>Aurelion\'s recipe is considerably more expensive.</strong> The apex craft now takes <strong>Solgaleo + Arceus + Necrozma</strong> from your party, <strong>128</strong> Fire Essence and <strong>128</strong> Steel Essence (was 64 each), <strong>50 Ancient DNA and 50 Future DNA</strong>, and <strong>250 Orbs</strong> (was 50). Future DNA is the point of it: Ancient DNA drops from the ancient Paradox bosses and Future DNA only from the Iron line, so the craft can no longer be finished off a single Area Zero rotation. <strong>Nobody is grandfathered and nothing is refunded</strong> — if you were stockpiling for the old numbers, these are the new ones. Aurelions already crafted are untouched, and <code>/pwiki</code> and <code>/guide</code> now quote the new recipe.' },
      { type: 'fixed', text: '🌌 <strong>Aurelion could be caught wild in Area Zero, free.</strong> A <code>/bingo</code> card could roll it, and Area Zero force-spawns your active hunt and bingo targets into its ambient pool — so it turned up wild and catchable at level 100, topped back up every 45 seconds. <strong>One player got one this way and it has since been discarded.</strong> No ASC custom species can now land on a hunt, a bingo card or an Area Zero spawn, and cards issued before the fix are re-checked at spawn time rather than trusted. The Paradox Synthesizer and the Arctis crate grand prize remain the only ways to get one.' },
      { type: 'fixed', text: '🏔️ <strong>Off-theme Pokémon stop leaking into Safari regions.</strong> A Metagross in the ice mountains, and Mesa Canyons producing windswept-hills mons — one bug, not two. A fifth of every Safari spawn was skipping the region pool entirely and handing you whatever the underlying <em>biome</em> produces. Pool membership now decides: a spawn that belongs to the region still rolls as before, so the pools stay exactly as varied, but an off-theme one is always replaced. (Archaludon in Crystal Field is in that pool on purpose — that one was working as designed.)' },
      { type: 'improved', text: '⚡ <strong><code>/legend</code> now tells you why a kill paid nothing.</strong> "Paradox kills don\'t count" turned out to be two silent limiters: the Alphas &amp; Paradox category <strong>caps after six defeats</strong>, and there is a daily earning budget on top. Both were real and neither said a word, which is indistinguishable from a broken counter. You now get a one-line reason naming which limit stopped it — they clear differently, and that difference is the point: a daily budget resets at midnight, a capped category only frees up when you spend the bar. <strong>Neither limit is relaxed.</strong> They are the anti-farm rules that also closed the PvP loop — only your first <strong>3 wins a day against the same opponent</strong> pay, a bout has to last 3 turns, and there is a 60-second cooldown between paying wins.' },
      { type: 'improved', text: '🔧 <strong>The redstone ladder is halved.</strong> Levers and rails at <strong>Intellect 3</strong>, dust and repeaters at <strong>6</strong>, pistons and observers at <strong>9</strong>, the Crafter at <strong>12</strong> — TNT alone still wants both Intellect and Wisdom at 20. We measured the old numbers against the save first: of the <strong>166 players with skill data, 8 could reach Intellect 14 at all and exactly 1 had it</strong>, while the median player had 2 points in total. A gate one player in 166 can open is not pacing, and it produces reports that say "redstone is broken" rather than "redstone is gated".' },
      { type: 'fixed', text: '📖 <strong>The dex repairs itself during your session, not only at login.</strong> Cobblemon only registers a species when it lands in your <em>party</em>, so a PC delivery, a wondertrade, a staff grant or a third-party hand-off registers nothing — our repair has covered that for months, but it ran on join only, so a Pokémon acquired at 14:00 kept rendering <code>???</code> until you relogged. It now reconciles every 30 seconds, and the label fixes itself without a relog.' },
      { type: 'improved', text: '🏰 <strong>Pokémon killed inside a dungeon drop nothing, held items included.</strong> Dungeon areas top up their spawns continuously, so Cobblemon drops made any dungeon a drop farm running <em>on top of</em> the run payout. Everything a run is meant to give still comes from its reward pools, loot caches and drop points, and <strong>battle EXP is untouched</strong>.' },
      { type: 'fixed', text: '🧰 <strong>Odds and ends.</strong> <code>/claim</code> was completely silent for anyone who already had a golden shovel — which is item 6 of the Rookie kit, so that was most new players, on a tutorial step telling them to run it; it explains the mechanic either way now. <code>/skinurl</code> accepts NameMC and CDN links that have no <code>.png</code> in the address (it always read the actual file to check — it was the filename it was fussy about). And if the alt gate ever refuses you on a <strong>first</strong> join, staff can now clear it: a refused connection used to leave no record anywhere, which made the one player who needed help invisible to every staff tool at once.' },
    ],
  },
  {
    date: '2026-08-14',
...
const CREDITS = [
  ...
  },
  {
    ...
    items: [
      { name: 'Sodium', ver: '0.8.12', by: 'CaffeineMC', url: 'https://modrinth.com/mod/sodium' },
      { name: 'Lithium', ver: '0.15.4', by: 'CaffeineMC', url: 'https://modrinth.com/mod/lithium' },
      ...
      { name: 'ImmediatelyFast', ver: '1.6.11', by: 'RaphiMC', url: 'https://modrinth.com/mod/immediatelyfast' },
      { name: 'Entity Culling', ver: '1.10.5', by: 'tr7zw', url: 'https://modrinth.com/mod/entityculling' },
      { name: 'Dynamic FPS', ver: '3.11.4', by: 'juliand665', url: 'https://modrinth.com/mod/dynamic-fps' },
      { name: 'ServerCore', ver: '1.5.19', by: 'Wesley1808', url: 'https://modrinth.com/mod/servercore' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '3D Skin Layers', ver: '1.11.2', url: 'https://modrinth.com/mod/3dskinlayers' },
      ...
      { name: 'Better Third Person', ver: '1.9.0', url: 'https://modrinth.com/mod/better-third-person' },
      { name: 'Advancement Plaques', ver: '1.6.8', url: 'https://modrinth.com/mod/advancement-plaques' },
      { name: 'Visuality', ver: '0.7.7', url: 'https://modrinth.com/mod/visuality' },
      { name: 'Particular', ver: '1.5.5', url: 'https://modrinth.com/mod/particular' },
      { name: 'Wakes', ver: '0.4.1', url: 'https://modrinth.com/mod/wakes' },
      { name: 'Reactive Music', ver: '1.2.2', url: 'https://modrinth.com/mod/reactive-music' },
      { name: 'Language Reload', ver: '1.7.6', url: 'https://modrinth.com/mod/language-reload' },
  ...
  },
  {
    group: 'Libraries & API',
    items: [
      { name: 'Fabric Loader', ver: '0.19.2', url: 'https://fabricmc.net/' },
      { name: 'Fabric API', ver: '0.116.14', url: 'https://modrinth.com/mod/fabric-api' },
      { name: 'Fabric Language Kotlin', ver: '1.13.13', url: 'https://modrinth.com/mod/fabric-language-kotlin' },
      { name: 'Architectury API', ver: '13.0.11', by: 'shedaniel', url: 'https://modrinth.com/mod/architectury-api' },
      { name: 'Cloth Config', ver: '15.0.140', by: 'shedaniel', url: 'https://modrinth.com/mod/cloth-config' },
      { name: 'owo-lib', ver: '0.12.15.4', by: 'glisco', url: 'https://modrinth.com/mod/owo-lib' },
      { name: 'GeckoLib', ver: '4.9.2', url: 'https://modrinth.com/mod/geckolib' },
      { name: 'Trinkets', ver: '3.10.0', url: 'https://modrinth.com/mod/trinkets' },
      { name: 'Accessories', ver: '1.1.0-beta.53', url: 'https://modrinth.com/mod/accessories' },
      { name: 'Accessories Compat Layer', ver: '0.1.12' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Every player has their own <b>Legend bar</b> — open it with <code>/legend</code>. Playing fills it, and <b>a full bar is a guaranteed Legendary</b>: spend it with <code>/legend roll</code> and one spawns <b>for you</b>. <b>Every spin costs 10 Orbs</b> whatever the bar reads — the fill decides the odds, the Orbs buy the spin, and they come back with your bar if the Legendary can\'t materialise. You can also cash out early from around <b>20%</b> — that\'s a gamble at the odds your bar has earned (50% of the bar is roughly a 25% chance, 75% is roughly 56%), and win or lose it costs you the whole bar. Either way the bar resets to 0% and you start building again. The old shared server-wide Global Energy bar is gone — legendary hunting is personal now.',
      },
      {
