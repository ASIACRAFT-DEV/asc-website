...
const NEWS = [
  {
    tag: 'New',
    title: 'Raids pay Orbs now, and commissions pay five times what they did',
    body: 'Orb income moved everywhere at once. <strong>Daily Commissions 1 → 5</strong>, <strong>Weekly 3 → 15</strong>, the Battle Tower and Warzone shops both <strong>10 → 20 a week</strong> — and <strong>raid bosses finally mint Orbs</strong>, 1–3 by rarity with +1 to the top damage dealer, capped at 15 a week. Raids were the last group activity paying none.',
    link: 'patchnotes.html',
  },
  {
    tag: 'New',
    title: 'Pick the 5★ you’re chasing — and pity survives a rotation',
    body: 'Name the featured legendary you want and a 5★ lands on <em>that</em> one. Rates are untouched — 0.2% base, 205/250 pity, the same 50/50. Separately: pity was keyed per banner, so <strong>every rotation wiped your counter</strong> while the rates panel promised it didn’t. All rotation banners now share one pool.',
    link: 'feature.html?f=crates',
  },
  {
    tag: 'Changed',
    title: 'The big dungeon bosses can finally hit you',
    body: 'Reach was measured centre-to-centre against a player-sized constant, so the <strong>Colossus, his Giants, the Warden, the Rayquaza pillar and the Sentinel</strong> were physically unable to land a swing while being trivially hittable themselves. Fixed, with knockback — and bosses now <strong>scale with party size</strong>. This is a difficulty increase.',
    link: 'feature.html?f=dungeons',
  },
  {
    tag: 'Fixed',
    title: 'Mega evolving cost you your Hidden Ability — and it was our own sweep',
    body: 'The pin that protects a Hidden Ability also un-pins any form listing one ability in both slots — a rule written for Ogerpon masks. <strong>All twelve mega forms do exactly that</strong>, so every mega evolution outside battle looked like a mask and lost the pin for good. It reads the standard form now.',
    link: 'patchnotes.html',
  },
];
